...
<body>
    <div class="container m-5">
        ...
        <div class="list-group list-group-numbered mt-4">
            ...
            {{-- kode selanjutnya letakkan di sini  --}}
        ...
        <div class="list-group mt4">
            <a href="{{ route('routeList')}}" class="list-group-item list-group-item-action">
        ...
        <div class="list-group mt4">
            <a href="{{ route('cacheList')}}" class="list-group-item list-group-item-action">
